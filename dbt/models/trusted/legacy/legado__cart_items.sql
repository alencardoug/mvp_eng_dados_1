...
-- Registros aptos de `legacy.cart_items`, na forma que `stg_retail__cart_items`
...
select
    (cleaned_payload->>'id')::bigint                    as cart_item_id,
    ...
    (cleaned_payload->>'added_at')::timestamptz         as added_at,
