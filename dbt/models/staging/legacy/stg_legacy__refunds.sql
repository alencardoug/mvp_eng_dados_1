...
select
    ...
    -- ── Valores tratados ─────────────────────────────────────────────────────
        ...
        case
            ...
            when c."refund_code" like '%;%' then c."refund_code"
    ...
    jsonb_build_object('id', c."id", 'refund_code', c."refund_code", 'payment_transaction_id', c."payment_transaction_id", 'amount', c."amount", 'reason', c."reason", 'status', c."status", 'refunded_at', c."refunded_at", 'created_at', c."created_at", 'updated_at', c."updated_at", 'deleted_at', c."deleted_at")              as original_payload
from captura c
