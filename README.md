...
| [Execução Local](docs/execucao_local.md) | Pré-requisitos e comandos de operação | v1.14 — o preparo do clone, o ciclo na ordem do B5, os alvos da Etapa 12 e o tamanho no `medir` |
