...
| [Execução Local](docs/execucao_local.md) | Pré-requisitos e comandos de operação | v1.15 — o preparo do clone, o ciclo na ordem do B5, os alvos da Etapa 12, o tamanho no `medir` e a reinstalação do Airbyte com o estado do Terraform |
