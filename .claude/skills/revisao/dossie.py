...
def gerar(
    ...
    partes += [
        ...
        "",
        f"{PENDENTE} — o que **esta** revisão precisa encontrar de pé além do mínimo acima, e em que",
        "estado: dados carregados, captura certificada, DAG registrada, tópico com eventos.",
        "",
        "## 7. Onde hesitei",
        "",
